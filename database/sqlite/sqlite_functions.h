...
#define COUNT_HOST_CHART_ACTIVE "select count(1) from chart ch, chart_active ca" \
"where hex(ch.host_id) = @host and ch.chart_id = ca.chart_id"
...
extern int count_host_chart_active(RRDHOST *host);
