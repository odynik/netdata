...
def Hop012RetrieveSamplesInorder(state):
    ...
    state.end_checks.append( lambda: state.compare_increment_value_and_duration("hop0"))
    state.end_checks.append( lambda: state.compare_increment_value_and_duration("hop1"))
    state.end_checks.append( lambda: state.compare_increment_value_and_duration("hop2"))
    # state.end_checks.append( lambda: state.get_api_data("hop0"))
    # state.post_checks.append( lambda: state.check_rep() )
    #################### END OF TEST CASES ####################