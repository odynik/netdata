...
struct sender_state {
    ...
    size_t expose_chart_definitions; // total number of chart definitions sent to the parent over each connection
    size_t expose_dim_definitions; // total number of dimension definitions sent to the parent over each connection
